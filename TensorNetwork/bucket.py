class Bucket:
	...
	addLink		-	Takes as input another Bucket and constructs a Link between this one and the other.
					Note that if a Link already exists a ValueError will be raised.
